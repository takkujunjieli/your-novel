...
- 轻度使用者: 习惯于传统阅读, 对不满意的场景会通过简单的交互进行微调 
...
- Basic Web/PWA frontend layout
- Age verification gate
- Single continuous AI reading/generation path

### Milestone 2: Retention & Library
- Content persistence (saving generated content)
- User library & bookmarks
- Basic "Continue Reading" logic

---

## 5. Disposable Code Acknowledgement
- Prompts and LLM integrations may be rewritten or migrated to self-hosted models (see ADR-0002).
- Optimize for speed of validation during MVP, not premature optimization.
